...
module.exports = function () {
	let config = new base();
	config.entity = {name: "Department"};
	config.entities = {name: "Departments"};
	...
	config.uiConfig.build = function () {
		...
		config.uiConfig.label("list", "List of Departments", "Lista de Departamente");
		config.uiConfig.label("itemDetails", "Department Details", "Detalii Departament");
