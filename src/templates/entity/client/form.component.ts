...
export class <%= entity.pascalCase %>FormComponent extends EntityFormComponent<<%= entity.pascalCase %>, <%= entities.pascalCase %>UiConfig, <%= entities.pascalCase %>ClientService> {
